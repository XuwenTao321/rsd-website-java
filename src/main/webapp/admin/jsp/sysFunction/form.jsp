...
<div class="formbody">
    ...
    <form action="/sysFunction/save" method="post">
        <input type="hidden" name="id" value="${sysFunction.id}"/>
        <ul class="forminfo">
            <li><label>角色功能</label><input name="name" type="text" class="dfinput" value="${sysFunction.name}" /><i>在下列选项中选择一个</i></li>
            <li><label>url</label><input name="url" type="text" class="dfinput" value="${sysFunction.url}" /><i>请填写路径</i></li>
