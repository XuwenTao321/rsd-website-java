...
<div class="formbody">
    ...
    <form id="myForm">
        ...
        <ul class="forminfo">
            <li><label>学生姓名</label><input name="name" type="text" class="dfinput"  /><i>学生姓名不能为空</i></li>
            <li><label>学生年龄</label><input name="age" type="text" class="dfinput"  /><i>学生年龄不能为空</i></li>
